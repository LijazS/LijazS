...
| 🚗 **[RideConnect – Ride Sharing Web App]([https://github.com/LijazS/RideConnect](https://github.com/LijazS/Projects/tree/main/Ride%20sharing%20website))** | Ride‑sharing platform with route matching, real‑time location, and trip management built on classic web tech and Google Maps API. | `PHP` · `MySQL` · `HTML` · `CSS` · `JavaScript` · `Google Maps API` |
